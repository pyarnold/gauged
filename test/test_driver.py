...
class TestDriver(TestCase):
    ...
    def test_insert_blocks(self):
        ...
        self.assertEqual(
            str(self.driver.get_block(0, 1, 2)[0]), '\xe4\x00\x12')
        self.driver.insert_or_append_blocks([(0,  1, 2, '\xe4\x00\x12', 0x10)])
        self.assertEqual(
            str(self.driver.get_block(0, 1, 2)[0]), '\xe4\x00\x12\xe4\x00\x12')
    ...
    def test_cache(self):
        ...
        self.assertSequenceEqual(
            self.driver.get_cache(1, id_, 2, 3, 4), ((3, 4),))
    ...
    def test_clear_from(self):
        ...
        self.assertSequenceEqual(
            self.driver.get_cache(0, id_, 5, 0, 100), [(13, 4)])
        self.assertListEqual(
            self.driver.get_namespace_statistics(1, 0, 3), [4, 5])
    ...
    def test_metadata(self):
        ...
        self.driver.set_metadata(
            {'foo': 'bar', 'qux': 'foobar'}, replace=False)
        self.assertEqual(self.driver.get_metadata('foo'), 'qux')
